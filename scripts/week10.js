...
let button = document.querySelector("button"); //добавляем обработчик события на кнопку
button.addEventListener("click", firstFunction); // при нажатии кнопки вызываем функцию
...
function greeting(guestName = "Гость") {
...
console.log(
  "С момента летней олимпиады в Токио прошло " +
...
const myAge = calculateAge1(birthYear);
console.log(myAge);
//Задание 18
